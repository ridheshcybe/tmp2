...
class EngineState(BaseModel):
    ...
    #: True while the engine is below operating temperature, when the
    #: warm-engine physics baseline does not apply and the index is indicative.
...
class MissionCreate(BaseModel):
    ...
    # "default" = the ~99-minute mission plan;
    # "test_flight" = compressed ~2.5-min idle→takeoff→cruise→landing demo.
    # "manual" = interactive idle-parked session for dashboard/phone control.
