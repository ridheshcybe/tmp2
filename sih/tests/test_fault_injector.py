...
class TestLeanBurnRunaway(_BaseTestCase):
...
class TestPistonRingWear(_BaseTestCase):
    ...
    def test_rpm_drops(self):
        ...
        for _ in range(300):
            f_faulty = inj.step(0.7)
        self.assertLess(f_faulty["rpm"], f_clean["rpm"])
    ...
    def test_vibration_increases(self):
        ...
        for _ in range(200):
            f_faulty = inj.step(0.7)
        self.assertGreater(f_faulty["vibration_rms_g"], f_clean["vibration_rms_g"])
    ...
    def test_oil_temp_rises(self):
        ...
        for _ in range(200):
            f_faulty = inj.step(0.7)
        self.assertGreater(f_faulty["oil_temp_c"], f_clean["oil_temp_c"])
...
class TestOilLeakPressureLoss(_BaseTestCase):
    ...
    def test_oil_pressure_drops(self):
        ...
        for _ in range(300):
            f_faulty = inj.step(0.7)
        self.assertLess(f_faulty["oil_pressure_kpa"], f_clean["oil_pressure_kpa"])
...
class TestSensorFreeze(_BaseTestCase):
...
class TestClearFaults(_BaseTestCase):
...
class TestMultipleFaults(_BaseTestCase):
...
class TestInvalidFaultType(_BaseTestCase):
